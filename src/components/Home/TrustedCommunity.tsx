    ...
    return (
        <div className='bg-[#F6FCFD] w-full'>
            <div className='w-full mx-auto py-[40px] sm:py-[50px]'>
                <h1 className='text-[#12142A] text-[24px] sm:text-[40px] sm:leading-[52px] font-bold text-center'>Trusted by our community</h1>
                <Swiper
                ...
                >
                    {testimonials.map((testimonial) => (
                        <SwiperSlide key={testimonial.id}>
                            <div
                                className='bg-white rounded-2xl flex-shrink-0 flex flex-col items-center text-center min-h-[421px] p-[20px] sm:p-[30px] max-w-[540px] mx-auto'
                                style={{
                                    boxShadow: '0px 4px 24px 0px #3A96AF14',
                                }}
                            >
                                <Image src='/assets/profile.svg' alt='profile' width={80} height={80} />
                                <h2 className='mt-4 mb-1 text-[#1C1F21] text-[18px] sm:text-[24px] sm:leading-[34px] font-medium'>{testimonial.name}</h2>
                                <h4 className='mb-3 text-[#4E555A] text-[14px] sm:text-[18px] font-medium sm:leading-[25px]'>{testimonial.role}</h4>
                                <p className='text-[#4E555A] text-[16px] sm:text-[20px] sm:leading-[26px] font-normal'>{testimonial.content}</p>
                            </div>
                        </SwiperSlide>
                    ))}
                </Swiper>
