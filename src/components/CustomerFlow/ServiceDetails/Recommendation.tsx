...
const recommendations = [
    {
        ...
        description: 'KESSRA Training connects you with expert coaches to support your personal and professional...',
        price: 30000,
    },
    {
        id: 2,
...
const Recommendation: React.FC = () => {
    return (
        <div className='mt-10'>
            <h1 className='text-[#252525] text-[20px] leading-[28px] font-bold tracking-[0.5px] mb-4'>Recommendation</h1>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5'>
                {recommendations.map((item) => (
                    <div key={item.id} className="bg-white border border-[#E8ECF4] rounded-xl p-3 overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <Image
                            src={item.image}
                            alt={item.title}
                            width={281}
