...
const MPesaPayment: React.FC<MPesaPaymentProps> = ({
  ...
  <div
    className={`border ${
      selected ? "border-[#3A96AF]" : "border-[#E8ECF4]"
  ...
  >
    <div className="flex items-center gap-2 sm:gap-4">
      ...
      <div className="flex-1">
        ...
        <p className="text-[14px] leading-[18px] sm:leading-[20px] font-medium text-[#64748B] mt-1">
    ...
    {selected && (
      <div className="mt-4 sm:mt-6 border-t-2 border-[#E8ECF4] pt-4 sm:pt-6">
        {!mpesaPromptSent ? (
          <>
            <label className="block text-[16px] leading-[20px] text-[#252525] font-medium mb-3">
              Phone Number
            </label>
            ...
            <div className="mb-4 sm:mb-6">
              <h4 className="mb-3 text-[16px] font-medium leading-[20px] tracking-[0.5px] text-[#252525]">
                How to Send?
              </h4>
              <ol className="text-[12px] leading-[16px] font-normal text-[#64748B] list-decimal list-inside space-y-2">
                ...
                <li>
                  You will receive a confirmation SMS from M-PESA with a
                  confirmation code.
                </li>
              </ol>
            </div>
          ...
          <>
            ...
            <div className="flex items-center gap-3 bg-[#F8FAFC] px-4 py-3.5 rounded-[12px] mb-4 max-w-[344px]">
              ...
              />
              <p className="text-[16px] leading-[20px] tracking-[0.5px] font-medium text-[#252525]">
                {phoneNumber}
              </p>
            </div>
            ...
            <div className="flex flex-col gap-2 sm:gap-3 mb-4 sm:mb-6 max-w-[504px]">
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                />
                <p className="text-[12px] sm:text-[14px] font-normal tracking-[0.5px] leading-[16px] sm:leading-[20px] text-[#252525]">
                  Once you've entered your M-PESA pin, click the PROCEED Button
            ...
            <div className="bg-[#3A96AF0D] p-3 flex items-center flex-wrap justify-between gap-4 rounded-lg sm:rounded-[16px] mb-4 sm:mb-6">
              <div>
                <div className="flex items-center gap-1 mb-1 mb-1">
                  <Image
                    ...
                    className="object-contain"
                  />
                  <p className="text-[14px] leading floats-[18px] font-medium text-[#3A96AF]">
                    Didn't Receive a payment prompt?
                  </p>
                </div>
                <p className="text-[12px] font-normal leading-[18px] sm:leading-[20px] text-[#3A96AF] ">
                  In case you've not payment prompt. Please click here to view
