    ...
    >
        <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
                <h3 className="text-[20px] leading-[20px] font-semibold text-[#252525]">M-Pesa Payment</h3>
                <p className="text-[14px] leading-[20px] font-medium text-[#64748B] mt-1">Do the payment through your Bank card</p>
            </div>
        </div>
        {selected && (
            <div className="mt-6 border-t-2 border-[#E8ECF4] pt-6">
                {!mpesaPromptSent ? (
                    <>
                    ...
                    <>
                        <p className="text-[16px] leading-[24px] font-medium tracking-[0.5px] text-[#252525] mb-4">
                        ...
                        <div className="flex flex-col gap-3 mb-6 max-w-[504px]">
                            <div className="flex items-start gap-3">
                                <Image src="/assets/icons/tag-right.svg" alt="Phone" width={16} height={16} className="object-contain" />
                                <p className="text-[14px] font-normal tracking-[0.5px] leading-[20px] text-[#252525]">
                        ...
                        <div className="bg-[#3A96AF0D] p-3 flex items-center justify-between gap-5 rounded-[16px] mb-6">
                            <div>
                                ...
                                <p className="text-[12px] font-normal leading-[20px] text-[#3A96AF] ">
                        ...
                        <RippleButton
                            className="w-fit bg-[#3A96AF] text-white py-3 px-[26px] rounded-lg text-[16px] tracking-[0.5px] leading-[20px] font-medium"
                            onClick={e => { e.stopPropagation(); handleProceedPayment(); }}
                        >
                            Proceed Payment
                        </RippleButton>
