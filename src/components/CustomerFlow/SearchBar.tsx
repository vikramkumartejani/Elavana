...
const SearchBar: React.FC<SearchBarProps> = ({ searchTerm, setSearchTerm, showFilters, setShowFilters }) => (
    <div className="flex items-center gap-3 justify-center w-full sm:flex-row flex-col">
        <div className='relative bg-[#F8FAFC] w-full rounded-xl flex items-center gap-2.5 px-3 md:px-4 h-[46px] md:h-[52px] border border-transparent hover:border-[#3A96AF] transition duration-200'>
            <svg className='md:w-6 md:h-6 w-5 h-5' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <RippleButton
            ...
            className="border border-[#2A6676] bg-[#3A96AF] rounded-md h-[46px] md:h-[48px] flex items-center gap-2.5 px-5 min-w-[116px]"
        >
