      ...
      <div className="w-full md:px-8 px-5">
        <div className="max-w-[1280px] mx-auto flex items-start justify-between md:flex-row flex-col gap-8">
          <div className="md:max-w-[280px] lg:max-w-[311px] flex flex-col gap-6 md:gap-[33px]">
            ...
            />
            <p className="text-[#747474] text-[14px] font-normal leading-[18px]">
              Elevana is a Kenyan-born platform connecting experts in coaching,
              mentoring, and personal growth with individuals seeking clarity
              and purpose.
            </p>
          </div>
          <div className="w-full md:w-fit grid grid-cols-2 md:flex items-start gap-6 sm:gap-8 md:gap-[49px] md:mt-1.5">
            <div className="lg:w-[176px]">
              <h2 className="text-[#12142A] text-[20px] leading-[26px] font-bold">
                Useful Links
              </h2>
              <div className="mt-4 sm:mt-6 flex flex-col gap-3.5">
                {usefulLinks.map((link) => (
                  <Link
                    key={link.href}
                    href={link.href}
                    className="text-[#747474] text-[14px] leading-[21px] font-normal transition duration-200 hover:text-[#3A96AF]"
                  >
                    {link.label}
                  </Link>
                ))}
      ...
      <div className="mt-12 md:mt-20 text-center pt-7 pb-5 border-t border-dashed border-[#A7A7A7] md:px-8 px-5">
        <div className="max-w-[1280px] mx-auto w-full">
          ...
          <div className="flex items-center w-full justify-between gap-2">
            <p className="text-[#747474] text-[14px] leading-[21px] font-normal">
              Copyright © 2025 Elevana. All Rights Reserved.
            </p>
            <div className="text-[#747474] text-[14px] leading-[21px] font-normal">
              <button className="text-[#747474] cursor-pointer text-[14px] leading-[21px] font-normal hover:underline">
                Privacy Policy
              </button>{" "}
              |{" "}
              <button className="text-[#747474] cursor-pointer text-[14px] leading-[21px] font-normal hover:underline">
