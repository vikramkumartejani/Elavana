            ...
            <div className='max-w-[1280px] mx-auto w-full py-[15px] flex items-center'>
                <div className='w-full flex items-center justify-between gap-5'>
                    ...
                    <div className='hidden lg:flex items-center gap-3'>
                        ...
                        <Button className='border border-[#3A96AF] h-[40px] rounded-md px-4 bg-[#3A96AF] text-white text-[12px] leading-[16px] font-medium'>Get Start Today</Button>
                    </div>
                    ...
                    <div className={`fixed top-0 right-0 h-full w-80 bg-white z-50 shadow-lg transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`} onClick={e => e.stopPropagation()}>
                        ...
                        <div className='flex flex-col space-y-4 px-5 py-8'>
                            ...
                            <div className='flex flex-col gap-3 pt-6 border-t border-[#DEE5ED]'>
                                ...
                                <Button className='border border-[#3A96AF] h-[40px] rounded-md px-4 bg-[#3A96AF] text-white text-[14px] leading-[18px] font-medium'>Get Start Today</Button>
                            </div>
                        </div>
                    </div>
                </>
