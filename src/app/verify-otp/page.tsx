    ...
    return (
        <div className="flex items-center justify-center min-h-screen md:px-8 px-5">
            <div className="w-full max-w-[420px] mx-auto h-auto bg-white px-5 py-8 sm:p-10 flex flex-col items-center justify-center" style={{ boxShadow: "0px 4px 24px 0px #25252514" }}>
                <h2 className="text-[#252525] text-[24px] sm:text-[32px] font-semibold text-center mb-2 sm:mb-4">Verify Code</h2>
                <p className="text-[#676D75] text-[16px] sm:text-[18px] text-center mb-8">Enter the 6-digit code sent to <span className="font-semibold">{email}</span>.</p>
                <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
                    <div className="flex flex-col gap-2">
                        <label htmlFor="otp" className="text-[14px] sm:text-[16px] font-medium text-black">Verification Code</label>
                        <input
                            id="otp"
                            type="text"
                            inputMode="numeric"
                    ...
                    <div className="flex flex-col items-center mt-2">
                        ...
                        {resendSuccess && <span className="text-green-600 text-[13px] mt-1">Code resent!</span>}
                    </div>
                    {success && <div className="text-green-600 text-center text-[14px]">Code verified! Redirecting...</div>}
                </form>
            </div>
        </div>
    );
