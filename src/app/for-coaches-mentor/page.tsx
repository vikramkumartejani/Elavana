                ...
                <div className="mt-[65px] mb-[88px] bg-[#3A96AF] max-w-[1280px] mx-auto w-full rounded-[12px] sm:rounded-[24px] py-8 lg:py-9 relative px-8 lg:px-[50px] flex items-center overflow-hidden">
                    ...
                    <div className="w-full flex items-center justify-between lg:flex-row flex-col gap-6">
                        <div className="max-w-[630px] lg:text-left text-center">
                            <h1 className="text-[18px] sm:text-[32px] lg:text-[42px] leading-[25px] sm:leading-[44px] lg:leading-[54.6px] font-bold text-white">Ready To Coach Smarter, Not Harder ?</h1>
                            <div className="mt-8 flex items-center justify-center lg:justify-start flex-wrap gap-3">
                                <RippleButton className="text-white text-[14px] sm:text-[20px] sm:leading-[24px] font-semibold border border-[#FFFFFF] rounded-xl px-6 h-11 sm:h-[56px] tracking-[0.5px]">Schedule Demo</RippleButton>
                                <RippleButton className="text-[#3A96AF] bg-[#F7F8F9] text-[14px] sm:text-[20px] sm:leading-[24px] font-semibold border border-[#FFFFFF] rounded-xl px-6 h-11 sm:h-[56px] tracking-[0.5px]">Start for free today</RippleButton>
                            </div>
                        </div>
